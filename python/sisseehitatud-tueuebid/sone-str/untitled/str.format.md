...
{% hint style="info" %}
soorita sõne vormindamise operatsioon
{% endhint %}

Kuna sõne on [muutumatu](../../../../terminid/sonastik/muutumatu-immutable.md) \(_immutable_\) [andmetüüp](../../../../terminid/sonastik/andmetueuep-datatype.md) \(_data type_\) siis vormindatud sõne on uus [objekt](../../../../terminid/sonastik/objekt-object.md) \(_object_\). 
